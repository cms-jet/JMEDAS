 ...
 * Most collisions involve quarks scattering.
 * Proton collisions are really gluon and quark collisions. Proton contain quarks and gluons

![Image alt text](../fig/episode1/jets101_1.svg "Jets"){width=50%}{: .image-with-shadow }

 <figure>
  <img src="../fig/episode1/jets101_1.svg" alt="" style="width:50%">
  <figcaption>Parton showering    → Hadronization   → Jet of color neutral particles</figcaption>
</figure>
{: .image-with-shadow }

 * Only particles in "color singlet” state observed in nature: confinement
 * Kinematic properties of the jet resemble that of the initial partons
 * Energy composition: About 65% charged hadrons, 25% neutral pions, 10% neutral hadrons.


![jets101_2](../fig/episode1/jets101_1.png){: .image-with-shadow }
